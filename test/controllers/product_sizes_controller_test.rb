...
class ProductSizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_size" do
    assert_difference('ProductSize.count') do
      post product_sizes_url, params: { product_size: { depth: @product_size.depth, height: @product_size.height, name: @product_size.name, product_size_category_id: @product_size.product_size_category_id, weight: @product_size.weight, width: @product_size.width } }
    end
  ...
  test "should update product_size" do
    patch product_size_url(@product_size), params: { product_size: { depth: @product_size.depth, height: @product_size.height, name: @product_size.name, product_size_category_id: @product_size.product_size_category_id, weight: @product_size.weight, width: @product_size.width } }
